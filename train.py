...
class TSCAN_trainer:
    def __init__(self, setup):
        ...
        v4v_data_train = V4V_Dataset(data_folder_path, setup.data_type, setup.image_type, setup.BP_type)
        v4v_data_valid = V4V_Dataset(data_folder_path, 'valid', setup.image_type, setup.BP_type)
        self.train_loader = DataLoader(dataset=v4v_data_train, batch_size=self.batch_size, shuffle=True, num_workers=0)
        self.valid_loader = DataLoader(dataset=v4v_data_valid, batch_size=self.batch_size, shuffle=True, num_workers=0)
        ...
        self.scheduler = torch.optim.lr_scheduler.OneCycleLR(self.optimizer, max_lr=self.lr, epochs=self.nb_epoch,
